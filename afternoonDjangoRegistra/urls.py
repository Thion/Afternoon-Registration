"""afternoonDjangoRegistra URL Configuration
...
urlpatterns = [
    ...
    path('home/', general_views.home, name='my_home'),
    path('logout/', auth_views.LoginView.as_view(template_name='logout.html'), name='user-logout'),
